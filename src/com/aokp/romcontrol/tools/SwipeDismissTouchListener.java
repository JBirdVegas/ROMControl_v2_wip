...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    private boolean mRemoveView = true;

    /**
     * The callback interface used by {@link com.aokp.romcontrol.tools.SwipeDismissTouchListener} to inform its client
